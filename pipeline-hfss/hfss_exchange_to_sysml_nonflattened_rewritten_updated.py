...
def emit_sysml(exchange: dict[str, Any]) -> str:
    ...
    a("    attribute method : ScalarValues::String;")
    a("    attribute frequencyRange : ScalarValues::String;")
    a("  }")
    a("")
    a("  part def MaterialSummary {")
    a("    attribute id : ScalarValues::String;")
    a("    attribute type : ScalarValues::String;")
    a("    attribute properties : ScalarValues::String;")
    a("  }")
    a("")
    a("  part def PortSummary {")
    a("    attribute id : ScalarValues::String;")
    a("    attribute type : ScalarValues::String;")
    a("    attribute location : ScalarValues::String;")
    a("    attribute impedance : ScalarValues::String;")
    a("  }")
    a("")
    a("  part def BoundarySummary {")
    a("    attribute id : ScalarValues::String;")
    a("    attribute type : ScalarValues::String;")
    a("    attribute appliesTo : ScalarValues::String;")
    a("  }")
    a("")
