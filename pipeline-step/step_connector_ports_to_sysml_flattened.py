...
def emit_sysml(exchange: dict) -> str:
    ...
    a("  }")
    a("")
    for idef in ["Usb32TypeC","Usb32TypeAStacked","Rj45Ethernet","DisplayPort","M2KeyE","M2KeyM4Lane","M2KeyM2Lane","CameraConnector","ExpansionHeader40Pin","ButtonHeader","CanBusHeader","FanConnector","DcPowerJack","OtherPort"]:
        a(f"  interface {idef} {{ }}")
    a("}")
    return "\n".join(lines) + "\n"
